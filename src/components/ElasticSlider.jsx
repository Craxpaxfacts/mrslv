// Компонент ElasticSlider — с анимацией, для громкости
...
export default function ElasticSlider({
  ...
  return (
    <div
      className={`slider-container swiper-no-swiping ${className}`}
...
function Slider({ defaultValue, startingValue, maxValue, isStepped, stepSize, leftIcon, rightIcon, onChange }) {
  ...
  const handlePointerDown = e => { e.stopPropagation(); handlePointerMove(e); e.currentTarget.setPointerCapture(e.pointerId); };
  ...
  return (
    <>
      ...
      >
        ...
        <div ref={sliderRef} className="slider-root" onPointerMove={handlePointerMove} onPointerDown={handlePointerDown} onPointerUp={handlePointerUp}>
          <motion.div
            style={{
              scaleX: useTransform(() => {
                if (sliderRef.current) {
