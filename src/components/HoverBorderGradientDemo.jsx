...
export function HoverBorderGradientDemo() {
  return (
    <div style={{ margin: '20px 0', display: 'flex', justifyContent: 'center', textAlign: 'center' }}>
      <HoverBorderGradient containerClassName="rounded-full sm" as="button" className="hbg-button sm">
        <AceternityLogo />
