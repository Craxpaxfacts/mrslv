...
export default function LiquidEther({
  ...
  useEffect(() => {
    ...
    class MouseClass {
      ...
      dispose() {
        if (!this.container) return;
        this.container.removeEventListener('mousemove', this._onMouseMove, { passive: true });
        this.container.removeEventListener('touchstart', this._onTouchStart, { passive: true });
        this.container.removeEventListener('touchmove', this._onTouchMove, { passive: true });
        this.container.removeEventListener('mouseenter', this._onMouseEnter, { passive: true });
        this.container.removeEventListener('mouseleave', this._onMouseLeave, { passive: true });
